...
## Project 1: MLB Pitch Effectiveness — 2026
...
Pitch effectiveness is important in baseball because pitchers use different pitch types to produce different outcomes against hitters. Understanding which pitches perform better across multiple measures can help provide a broader view of pitching performance and player evaluation.
...
Third, seven pitcher–pitch type observations were missing average exit velocity. All seven were curveballs. These observations were retained rather than removing them, so the Effectiveness Score for those observations was calculated using the available metrics.
